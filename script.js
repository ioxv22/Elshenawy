...
function initializeWelcomeScreen() {
    ...
    function typeMessage() {
        if (charIndex < messages[messageIndex].length) {
            ...
            charIndex++;
            setTimeout(typeMessage, 50); // Faster typing (was 100ms)
        } else {
            setTimeout(() => {
            ...
            }, 800); // Shorter pause between messages (was 2000ms)
        }
    }
    
    // Start typing animation faster
    setTimeout(typeMessage, 500); // Start sooner (was 2000ms)
    ...
    function updateProgress() {
        if (isSkipped) return; // Stop if user skipped
        ...
        if (stepIndex < progressSteps.length) {
            ...
            stepIndex++;
            setTimeout(updateProgress, 400); // Much faster steps (was 800ms)
        } else {
            // Hide welcome screen faster
            setTimeout(() => {
                if (!isSkipped) {
                    skipWelcomeScreen();
                }
            }, 300); // Start hiding sooner (was 1000ms)
        }
    }
    
    // Start progress animation much sooner
    setTimeout(updateProgress, 800); // Start much sooner (was 3000ms)
}
...
function forceCreateVideos() {
    ...
    console.log('🚀 Videos forcefully saved to localStorage:', defaultCourses.length);
    return defaultCourses;
}

// Emergency video display function
function emergencyDisplayVideos() {
    console.log('🚨 EMERGENCY: Force displaying videos with direct HTML injection...');
    const coursesGrid = document.querySelector('.courses-grid');
    if (!coursesGrid) {
        console.error('🚨 EMERGENCY: No courses grid found!');
        return;
    }
    
    // Check if videos are already loaded and protected
    if (coursesGrid.getAttribute('data-videos-loaded') === 'true') {
        console.log('🛡️ EMERGENCY ABORTED: Videos are already loaded and protected');
        return;
    }
    
    // Check if there are already protected course cards
    const protectedCards = coursesGrid.querySelectorAll('.course-card[data-protected="true"]');
    if (protectedCards.length > 0) {
        console.log('🛡️ EMERGENCY ABORTED: Found', protectedCards.length, 'protected course cards');
        return;
    }
    
    const videosHTML = `
        <div class="course-card grade9" data-aos="fade-up">
            <div class="course-thumbnail">
                <img src="https://via.placeholder.com/400x225/1e3a8a/ffffff?text=فيزياء+الصف+التاسع+المتقدم" alt="فيديو فيزياء صف 9 متقدم" loading="lazy">
                <div class="course-duration">120 دقيقة</div>
                <div class="course-overlay">
                    <button class="play-btn" onclick="window.open('https://drive.google.com/file/d/1vOihXtyhX7Xptn0kOs1fISHXsBQOzxum/view?usp=drive_link', '_blank')">
                        <i class="fas fa-play"></i>
                    </button>
                </div>
            </div>
            <div class="course-info">
                <h3>فيديو فيزياء صف 9 متقدم</h3>
                <p>شرح شامل ومبسط لمنهج الصف التاسع المتقدم</p>
                <div class="course-meta">
                    <span class="course-type">درس</span>
                    <span class="course-grade">الصف التاسع</span>
                </div>
                <button class="course-btn free" onclick="window.open('https://drive.google.com/file/d/1vOihXtyhX7Xptn0kOs1fISHXsBQOzxum/view?usp=drive_link', '_blank')">
                    <i class="fas fa-play"></i> مشاهدة مجانية
                </button>
            </div>
        </div>
        
        <div class="course-card grade10" data-aos="fade-up">
            <div class="course-thumbnail">
                <img src="https://via.placeholder.com/400x225/3b82f6/ffffff?text=فيزياء+الصف+العاشر+المتقدم" alt="فيديو صف 10 متقدم" loading="lazy">
                <div class="course-duration">135 دقيقة</div>
                <div class="course-overlay">
                    <button class="play-btn" onclick="window.open('https://drive.google.com/file/d/1iTO2628HDuKpEdPG5_z2VV-v0hHAs8sI/view?usp=drive_link', '_blank')">
                        <i class="fas fa-play"></i>
                    </button>
                </div>
            </div>
            <div class="course-info">
                <h3>فيديو صف 10 متقدم</h3>
                <p>شرح مفصل لمنهج العاشر المتقدم بطريقة ممتازة</p>
                <div class="course-meta">
                    <span class="course-type">درس</span>
                    <span class="course-grade">الصف العاشر</span>
                </div>
                <button class="course-btn free" onclick="window.open('https://drive.google.com/file/d/1iTO2628HDuKpEdPG5_z2VV-v0hHAs8sI/view?usp=drive_link', '_blank')">
                    <i class="fas fa-play"></i> مشاهدة مجانية
                </button>
            </div>
        </div>
        
        <div class="course-card grade11" data-aos="fade-up">
            <div class="course-thumbnail">
                <img src="https://via.placeholder.com/400x225/f59e0b/ffffff?text=فيزياء+صف+11+متقدم" alt="فيديو فيزياء صف 11 متقدم" loading="lazy">
                <div class="course-duration">145 دقيقة</div>
                <div class="course-overlay">
                    <button class="play-btn" onclick="window.open('https://drive.google.com/file/d/1hD5GUReRwAz5L-AJd-IaxKqqJ00DZkJJ/view?usp=drive_link', '_blank')">
                        <i class="fas fa-play"></i>
                    </button>
                </div>
            </div>
            <div class="course-info">
                <h3>فيديو فيزياء صف 11 متقدم</h3>
                <p>الفيديو الأصلي لمنهج الحادي عشر المتقدم كاملاً</p>
                <div class="course-meta">
                    <span class="course-type">درس</span>
                    <span class="course-grade">الصف الحادي عشر</span>
                </div>
                <button class="course-btn free" onclick="window.open('https://drive.google.com/file/d/1hD5GUReRwAz5L-AJd-IaxKqqJ00DZkJJ/view?usp=drive_link', '_blank')">
                    <i class="fas fa-play"></i> مشاهدة مجانية
                </button>
            </div>
        </div>
    ...
    coursesGrid.innerHTML = videosHTML;
    
    // Protect the newly added videos
    const newCourseCards = coursesGrid.querySelectorAll('.course-card');
    newCourseCards.forEach((card, index) => {
        card.setAttribute('data-protected', 'true');
        card.classList.add('protected-video');
        console.log(`🛡️ Protected emergency video ${index + 1}`);
    });
    
    coursesGrid.setAttribute('data-videos-loaded', 'true');
    console.log('🚨 EMERGENCY: Videos displayed with direct HTML injection and protected!');
}

// Make functions globally accessible for debugging
window.forceCreateVideos = forceCreateVideos;
window.loadAndDisplayVideos = loadAndDisplayVideos;
window.loadVideosFromAdmin = loadVideosFromAdmin;
window.emergencyDisplayVideos = emergencyDisplayVideos;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // PRESERVE EXISTING VIDEOS FIRST
    const coursesGrid = document.querySelector('.courses-grid');
    if (coursesGrid) {
        const existingCourseCards = coursesGrid.querySelectorAll('.course-card');
        if (existingCourseCards.length > 0) {
            console.log('🎯 PRESERVING existing course cards - will not load from JavaScript');
            
            // Just ensure they're visible and initialize filtering
            existingCourseCards.forEach((card, index) => {
                card.style.display = 'block';
                card.style.opacity = '1';
                card.style.visibility = 'visible';
                console.log(`✅ Preserved course card ${index + 1}`);
            });
            
            initCategoryButtons();
            
            // Continue with other initialization (don't return here)
            console.log('✅ Videos preserved, continuing with other initializations...');
        } else {
            // Only run video loading if no HTML course cards exist
            console.log('🎥 No HTML course cards found, attempting JavaScript loading...');
            
            // FORCE CREATE VIDEOS ONLY IF NEEDED
            forceCreateVideos();
            
            // Load and display videos immediately
            console.log('🎥 Loading videos from JavaScript...');
            loadAndDisplayVideos();
            console.log('🎥 JavaScript videos loaded!');
            
            // Only do emergency fallback if really needed
            setTimeout(() => {
                const coursesGrid = document.querySelector('.courses-grid');
                if (coursesGrid) {
                    const courseCards = coursesGrid.querySelectorAll('.course-card');
                    console.log('🔍 Final check: found', courseCards.length, 'course cards');
                    
                    if (courseCards.length === 0) {
                        console.log('🚨 EMERGENCY: No course cards found at all - using emergency display');
                        emergencyDisplayVideos();
                    }
                }
            }, 2000);
        }
